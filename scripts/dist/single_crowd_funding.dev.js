...
var mobile_crowd_funding_container = document.querySelector(".crowd_fundings"); // delete form variables

var delete_btn = document.querySelector(".delete_btn");
var delete_form = document.querySelector(".delete_form");
var cancel_delete_btn = document.querySelector(".cancel-btn"); // event listeners and actions
